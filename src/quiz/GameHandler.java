...
// Übernimmt zunächst das Verteilen des ausgewählten Catalogs; Verteilt später eventuell auch die Fragen 
public class GameHandler extends Thread{
	public static final GameHandler handler= new GameHandler();
